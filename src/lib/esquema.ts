/**
 * Esquema de la base de datos, incrustado en el codigo a proposito.
 *
 * Antes se leia de db/schema.sql con una ruta construida a partir del
 * directorio de trabajo. El empaquetador de Next no puede detectar esas rutas,
 * asi que el fichero podia no llegar al servidor y la aplicacion fallaba al
 * arrancar. Incrustado no puede faltar.
 */
